...
def load_dataset_5folders (root, dataset, split_method):
    train_txt = root + '/' + dataset + '/' + split_method + '/' + 'train_110_131.txt'
    test_txt  = root + '/' + dataset + '/' + split_method + '/' + 'test_110_131.txt'
    # val_txt = root + '/' + dataset + '/' + split_method + '/' + 'val.txt'
    train_img_ids = []
    val_img_ids = []
    test_img_ids = []
